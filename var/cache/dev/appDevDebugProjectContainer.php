...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oc_user.profile.form.type' => 'getOcUser_Profile_Form_TypeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AppUserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/AppBundle/Entity')));

        $d = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $d->addDriver($b, 'FOS\\UserBundle\\Entity');
        $d->addDriver($c, 'AppUserBundle\\Entity');
        $d->addDriver($c, 'AppBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'AppUserBundle' => 'AppUserBundle\\Entity', 'AppBundle' => 'AppBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8c3e636c2bcf4c87a723bb2a1e6eaeae817e89802a2f399a8810e72636acd90a');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('testmaillesheureusesnaissances@gmail.com' => 'Les Heureuses Naissances'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form'] = $this->get('form.factory')->createNamed('fos_user_profile_form', 'AppUserBundle\\Form\\Type\\ProfileFormType', NULL, array('validation_groups' => array(0 => 'Profile', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('AppUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form'] = $this->get('form.factory')->createNamed('fos_user_registration_form', 'AppUserBundle\\Form\\Type\\RegistrationFormType', NULL, array('validation_groups' => array(0 => 'Registration', 1 => 'Default')));
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('AppUserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'AppUserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'oc_user.profile.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppUserBundle\Form\Type\ProfileFormType A AppUserBundle\Form\Type\ProfileFormType instance.
     */
    protected function getOcUser_Profile_Form_TypeService()
    {
        return $this->services['oc_user.profile.form.type'] = new \AppUserBundle\Form\Type\ProfileFormType('AppUserBundle\\Entity\\User');
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \AppUserBundle\Form\Type\RegistrationFormType A AppUserBundle\Form\Type\RegistrationFormType instance.
     */
    protected function getOcUser_Registration_Form_TypeService()
    {
        return $this->services['oc_user.registration.form.type'] = new \AppUserBundle\Form\Type\RegistrationFormType('AppUserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('AppUserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '99ce2ad709f98244ba5015e8d5661e068c4f9f54', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $m = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $k, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($k, '/1'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => 'fos_user_security_logout'));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('testmaillesheureusesnaissances@gmail.com');
        $a->setPassword('ppdmiage2016');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/AppUserBundle/Resources/views'), 'AppUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('99ce2ad709f98244ba5015e8d5661e068c4f9f54');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '99ce2ad709f98244ba5015e8d5661e068c4f9f54', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57148fd6efda96.10238676')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AppUserBundle' => 'AppUserBundle\\AppUserBundle',
            ...
            'mailer_user' => 'testmaillesheureusesnaissances@gmail.com',
            'mailer_password' => 'ppdmiage2016',
            'secret' => '99ce2ad709f98244ba5015e8d5661e068c4f9f54',
            'locale' => 'fr',
            ...
            'kernel.secret' => '99ce2ad709f98244ba5015e8d5661e068c4f9f54',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'testmaillesheureusesnaissances@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'ppdmiage2016',
            ...
            'fos_user.model.user.class' => 'AppUserBundle\\Entity\\User',
            'fos_user.template.engine' => 'twig',
            'fos_user.profile.form.type' => 'AppUserBundle\\Form\\Type\\ProfileFormType',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'testmaillesheureusesnaissances@gmail.com' => 'Les Heureuses Naissances',
            ),
            'fos_user.registration.confirmation.enabled' => true,
            'fos_user.registration.form.type' => 'AppUserBundle\\Form\\Type\\RegistrationFormType',
